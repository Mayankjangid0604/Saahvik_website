      ...
      >
        {PROBLEMS.map(({ label, icon: Icon }) => (
          <motion.div
            ...
            whileHover={{ y: -6 }}
            className="group relative overflow-hidden rounded-3xl border border-line bg-surface/60 p-5 shadow-soft backdrop-blur-sm transition-colors duration-300 hover:border-gold-400/50 sm:p-6"
          >
            {/* hover sheen */}
